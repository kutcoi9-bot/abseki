...
<head>
    ...
    <title>Scan Barcode - <?php echo strip_tags($site_name); ?></title>
    <link rel="icon" href="../sw-content/<?php echo $site_favicon; ?>" type="image/png">
    ...
    <div class="appHeader">
        <div class="pageTitle">
            <a href="../" style="color:white; text-decoration:none;">
                <img src="../sw-content/<?php echo $site_logo; ?>" alt="logo" style="height:30px; background:white; padding:2px; border-radius:4px;">
                ...
                <div class="col-md-5">
                    ...
                    <div class="card card-custom">
                        <div class="card-body text-center">
                            <h5 class="text-muted mb-1"><?php echo format_hari_tanggal($date); ?></h5>
                            <h3 class="clock text-primary" style="font-weight:bold; font-size:32px; margin:0;"></h3>

                            <div class="mt-3 badge badge-light p-2 schedule-badge">
                                <?php if ($info_jadwal) { ?>
                                    Jadwal: <?php echo $info_jadwal['jam_masuk']; ?> - <?php echo $info_jadwal['jam_pulang']; ?>
                                <?php } else { ?>
                                    <span class="text-danger">Hari ini Libur</span>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-custom bg-white">
                        <div class="card-body">
                            ...
                            <div class="audio-panel">
                                <button type="button" id="enableAudioBtn" class="btn-audio-enable">
                                    Aktifkan Audio
                                </button>
                                <div class="audio-status text-muted">
                                    Klik sekali tombol ini sebelum mulai scan.
                                </div>
                            </div>
                            ...
                            <div class="scanner-note">
                                <b>Catatan:</b><br>
                                - Barcode/NISN harus 10 digit angka.<br>
                                - GPS harus aktif agar lokasi bisa dikirim ke sistem.<br>
                                - Link lokasi akan ikut terkirim ke pesan orang tua jika lokasi tersedia.
                            </div>
                        </div>
                    </div>
